...
export function SignupForm() {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    toast.success("Account created! Welcome to TimeTrack.");
  ...
  return (
    <Card className="w-full max-w-md shadow-xl">
      <CardHeader className="space-y-3 text-center pb-4">
        ...
        <CardDescription>Start tracking your time for free</CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div className="space-y-1.5">
            ...
            <Input id="name" placeholder="Jane Doe" {...register("name")} className={errors.name ? "border-destructive" : ""} />
